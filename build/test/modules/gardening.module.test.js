...
import { createSandbox, fake, useFakeTimers } from "sinon";
import { test } from "tap";
import { ImportMock } from "ts-mock-imports";
import { container, injectable } from "tsyringe";
import { Database } from "../../src/config/databaseConfiguration.js";
import { Reason, Reservation, Slot } from "../../src/models/gardeningConfig.model.js";
...
test("Gardening Module Tests:", async (t) => {
    ...
    await t.test("Validation of Plots and Slots", async (t) => {
        ...
        await t.test("should return void when no plots.", async (t) => {
            ...
            t.ok(interaction.reply.called, "Interaction was called.");
...
//# sourceMappingURL=gardening.module.test.js.map