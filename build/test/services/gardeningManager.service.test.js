...
import { InvalidArgumentError } from "../../src/utils/errors/invalidArgumentError.js";
...
describe("The garden service's", () => {
    ...
    const interaction = {
        ...
        options: { getBoolean: (key) => { return options[key] ?? null; } },
    };
...
//# sourceMappingURL=gardeningManager.service.test.js.map