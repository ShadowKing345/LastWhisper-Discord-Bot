...
let ManagerUtilsConfigRepository = class ManagerUtilsConfigRepository extends BasicRepository {
    db;
...
ManagerUtilsConfigRepository = __decorate([
    injectable(),
    __metadata("design:paramtypes", [Database])
], ManagerUtilsConfigRepository);
export { ManagerUtilsConfigRepository };
//# sourceMappingURL=managerUtilsConfig.repository.js.map