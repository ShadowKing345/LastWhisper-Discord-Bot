...
let BuffManagerConfigRepository = class BuffManagerConfigRepository extends BasicRepository {
    db;
...
BuffManagerConfigRepository = __decorate([
    injectable(),
    __metadata("design:paramtypes", [Database])
], BuffManagerConfigRepository);
export { BuffManagerConfigRepository };
//# sourceMappingURL=buffManagerConfig.repository.js.map